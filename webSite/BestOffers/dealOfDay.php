...
<div class='row dead-card' style = "margin-top: 7px;">
    <div class='deal-header'>Deal of the day 
    <span id = 'time'>12:40:05 left</span>
    <a href="#" class = "light-blue darken-3 white-text right" style = "padding: 0px 10px; font-weight: 400;">View all</a><hr><p></p></div>

<?php
    $get_products = "SELECT * FROM product WHERE catagories = 'All' ORDER BY 1 DESC limit 6";
